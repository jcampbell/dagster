...
| <PyObject module="dagster" object="pipeline" displayText="@pipeline" /> | The decorator used to define a pipeline. The decorator returns a <PyObject object="PipelineDefinition" />. See [Pipelines](/concepts/solids-pipelines/solids-pipelines/) to learn more.                                                                           |
| <PyObject object="daily_schedule" decorator />                          | The decorator that defines a schedule that executes every day at a fixed time. The decorator returns a <PyObject object="ScheduleDefinition" />. See [Schedules](/concepts/partitions-schedules/schedules) to learn more about ways to define different schedules |
| <PyObject object="sensor" decorator />                                  | The decorator used to define sensors. The decorator returns a <PyObject object="SensorDefinition" />. See [Sensors](/concepts/partitions-schedules/sensors) to learn more.                                                                                        |
| <PyObject object="PartitionSetDefinition" />                            | The class used to define a partition set. See [Partitions](/concepts/partitions-schedules/partitions) to learn more about ways to define partition sets.                                                                                                          |
